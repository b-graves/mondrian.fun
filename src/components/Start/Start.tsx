    ...
    return (
      <div>
        ...
        <div className="start__description">
          This site is a celebration of the artistic style of Piet Mondrian, a 20th century Dutch artist best known for his abstract works using vertical and horizontal lines and the primary colors. Here you can create your own masterpiece in the style of Mondrian and then hang it in the virtual gallery alongside other people's work. Head to the studio to get started or visit the gallery for some inspiration... 
        </div>
